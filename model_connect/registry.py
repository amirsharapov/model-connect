...
def get_model_integration(dataclass_type: type, integration_class: type):
    return get(dataclass_type).model.integrations.get(integration_class)


def get_model_field_integration(dataclass_type: type, field_name: str, integration_class: type):
